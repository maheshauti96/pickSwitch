...
/// everything else in `PeekSwitchCore` stays internal so tests can use
/// `@testable import`.
@MainActor
public final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    public func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        Log.app.info("PeekSwitch \(MenuBarController.versionString, privacy: .public) started")
    }
    ...
    public func applicationWillTerminate(_ notification: Notification) {
        ...
        Log.app.info("PeekSwitch terminating")
    }
    ...
    private func showSettings() {
        ...
        let window = makeWindow(title: "PeekSwitch Settings", content: view)
    ...
    private func showOnboarding() {
        ...
        let window = makeWindow(title: "PeekSwitch Setup", content: view)
...
extension AppDelegate: NSWindowDelegate {
    public func windowWillClose(_ notification: Notification) {
        ...
        // Drop back to accessory so closing a window does not leave PeekSwitch
        // sitting in the Dock.
        NSApp.setActivationPolicy(.accessory)
    }
}
