...
BRAND_SVG="$PROJECT_ROOT/site/img/brand/svg"
...
MARK_SOURCE="$BRAND_SVG/vortexflow-mark-pastel.svg"
...
# The four-colour ring without the paper squircle. Finder still uses the plated
...
rasterize_svg "$MARK_SOURCE" "$MARK_MASTER" 1024
...
# four card colours that *are* the logo. Status items are 18 pt.
